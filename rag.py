...
class RAGAssistant:
    ...
    def _create_prompt(self, query: str, context: str) -> str:
        ...
        """
        prompt = f"""Ты — онлайн-ассистент компании Континент Окна Крым, которая занимается установкой пластиковых и алюминиевых окон и дверей.

ВАЖНО: 
- Отвечай на основе предоставленного контекста
- Если в контексте нет информации для ответа, честно скажи об этом
- Отвечай на русском языке
- Будь кратким, конкретным и информативным
        ...
        try:
            response = self.client.chat.completions.create(
                ...
                messages=[
                    {
                        "role": "system",
                        "content": "Ты — онлайн-ассистент компании Континент Окна Крым, который отвечает на вопросы на основе предоставленного контекста."
                    },
                    {
                        "role": "user",
                        "content": prompt
